...
constructor(
    ...
    val getStandings = repository.getStandings("api-basketball.p.rapidapi.com", "0c42b61f32mshd336f80f0806bb5p150e69jsn83cc84b177b5").asLiveData()

    val getEasternConference = repository.getEasternConference("Eastern Conference").asLiveData()

    val getWesternConference = repository.getEasternConference("Western Conference").asLiveData()
